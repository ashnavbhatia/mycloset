class ClothingTypeIdsController < ApplicationController
  before_action :set_clothing_type_id, only: [:show, :edit, :update, :destroy]
  ...
  def create
    ...
    if @clothing_type_id.save
      redirect_to @clothing_type_id, notice: 'Clothing type was successfully created.'
    else
      render :new
    end
  end
  ...
  def update
    if @clothing_type_id.update(clothing_type_id_params)
      redirect_to @clothing_type_id, notice: 'Clothing type was successfully updated.'
    else
      render :edit
    end
  end
  ...
  def destroy
    ...
    redirect_to clothing_type_ids_url, notice: 'Clothing type was successfully destroyed.'
  end
